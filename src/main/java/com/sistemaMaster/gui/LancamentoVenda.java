...
import com.sistemaMaster.dao.VendaDAO;
import com.sistemaMaster.gui.auxiliar.FormaPagamento;
import com.sistemaMaster.gui.tm.ItemVendaTableModel;
import com.sistemaMaster.gui.tm.VendaTableModel;
import com.sistemaMaster.to.Cliente;
import com.sistemaMaster.to.ItemVenda;
import com.sistemaMaster.to.Produto;
import com.sistemaMaster.to.Venda;
...
public class LancamentoVenda extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        ftMaoDeObra = new javax.swing.JFormattedTextField();
        ...
        lbRodapeValorTotal = new javax.swing.JLabel();
        ftfRodapeValorTotal = new javax.swing.JFormattedTextField();
        ...
        btFinalizar
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sistemaMaster/gui/img/finalizar.png"))); // NOI18N
        ...
        btFinalizar.setRolloverIcon(
                new javax.swing.ImageIcon(getClass().getResource("/com/sistemaMaster/gui/img/finalizar-foco.png"))); // NOI18N
        ...
        ftfCliente.setMinimumSize(new java.awt.Dimension(150, 25));
        ...
        btCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sistemaMaster/gui/img/buscar.png"))); // NOI18N
        ...
        btCliente.setRolloverIcon(
                new javax.swing.ImageIcon(getClass().getResource("/com/sistemaMaster/gui/img/buscar-foco.png"))); // NOI18N
        ...
        ftfProduto.setMinimumSize(new java.awt.Dimension(150, 25));
        ...
        btProduto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sistemaMaster/gui/img/buscar.png"))); // NOI18N
        ...
        ftfValorUnitario.setMinimumSize(new java.awt.Dimension(150, 25));
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        pnFormItens.add(lbMaoDeObra, gridBagConstraints);

        ftMaoDeObra.setColumns(10);
        ftMaoDeObra.setMinimumSize(new java.awt.Dimension(150, 25));

        ftMaoDeObra.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
                new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        ftMaoDeObra.setValue(new Double(0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
        pnFormItens.add(ftMaoDeObra, gridBagConstraints);

        btAdicionarItem
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sistemaMaster/gui/img/novo.png"))); // NOI18N
        btAdicionarItem.setToolTipText("Adicionar item");
        btAdicionarItem.setPreferredSize(new java.awt.Dimension(35, 30));
        btAdicionarItem.setRolloverIcon(
                new javax.swing.ImageIcon(getClass().getResource("/com/sistemaMaster/gui/img/novo-foco.png"))); // NOI18N
        ...
        btRemoverItem
                .setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sistemaMaster/gui/img/excluir.png"))); // NOI18N
        ...
        // Painel do rodapé
        pnRodape.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT));

        lbRodapeValorTotal.setText("Valor Total da Venda:");

        // Campo formatado para valor total
        ftfRodapeValorTotal.setEditable(false);
        ftfRodapeValorTotal.setColumns(10);
        ftfRodapeValorTotal.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
                new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.00"))));
        ftfRodapeValorTotal.setValue(new Double(0));

        // Adiciona ao painel
        pnRodape.add(lbRodapeValorTotal);
        pnRodape.add(ftfRodapeValorTotal);

        // Adiciona o painel ao rodapé da janela
        getContentPane().add(pnRodape, java.awt.BorderLayout.PAGE_END);
    ...
    private void habilitarFormulario(boolean ativo) {
        ...
        opcaoPagamento.setEnabled(ativo);
        tbGrade.setEnabled(!ativo);
        ftMaoDeObra.setEnabled(ativo);
    ...
    private javax.swing.JFormattedTextField ftfRodapeValorTotal;
    private javax.swing.JFormattedTextField ftfValorTotal;
    private javax.swing.JFormattedTextField ftfValorUnitario;
    private javax.swing.JFormattedTextField ftMaoDeObra;
    private javax.swing.JComboBox<FormaPagamento> opcaoPagamento;
    ...
    private javax.swing.JLabel lbRodapeValorTotal;

...
<p>Ferramentas utilizadas:
  <ul>
    ...
    <li>MySQL Connector JDBC 5.1.23</li>// atualização para mysql-connector-j-9.1.0
...
<p>Atualizado e implementado por Felipe da Costa Catarino / email: felipecatarinu@gmail.com</p>
